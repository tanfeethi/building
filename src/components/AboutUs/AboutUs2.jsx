...
const AboutUs2 = () => {
    return (
        <Container className="p-8 bg-white">
            ...
            {/* "قصتنا" Section */}
            <div className="flex flex-col 2xl:flex-row items-center justify-between mb-8xl">
                <div className="2xl:w-1/2 mt-4 lg:mt-0">
                    <img src={aboutusSection1} alt="Our Story" className="w-full h-auto rounded-lg shadow-lg" />
                </div>
                <div className="2xl:w-1/2 text-right">
                    <h2 className="text-text-primary text-3xl me-8 font-bold mb-4">قصتنـــــــــا</h2>
                    <p className="text-text-primary-dark me-8">
            ...
            <div className="flex flex-col 2xl:flex-row items-center justify-between mb-8xl">
                <div className="2xl:w-1/2 text-right">
                    <h2 className="text-text-primary text-3xl me-8 font-bold mb-4">رؤيتنــــــــا</h2>
                    <p className="text-text-primary-dark me-8">
            ...
            {/* "هدفنا" Section */}
            <div className="flex flex-col 2xl:flex-row-reverse items-center justify-between mb-8xl">
                <div className="2xl:w-1/2 text-right">
                    <h2 className="text-text-primary text-3xl me-8 font-bold mb-4">هدفنــــــا</h2>
                    <p className="text-text-primary-dark me-8">
            ...
            <div className="flex flex-col 2xl:flex-row items-center justify-between">
                <div className="2xl:w-1/2 text-right">
                    <h2 className="text-text-primary text-3xl me-8 font-bold mb-4">قيمنــــــــا</h2>
                    <p className="text-text-primary-dark me-8 mb-2"><strong>الجودة والإتقان</strong> نحرص على تحقيق أعلى مستويات الجودة في جميع مشاريعنا. وتستخدم أحدث التقنيات والمواد ذات الجودة العالية لضمان نتائج ممتازة ونضمن تنفيذ الأعمال بدقة واحترافية عالية مع الالتزام بالمواصفات والمعايير.</p>
                    <p className="text-text-primary-dark me-8 mb-2"><strong>الثقة والمصداقية</strong> تلتزم بتلبية متطلبات واحتياجات عملائنا ونلتزم بتحقيق المواعيد المحددة مما يعزز لفتهم بنا.</p>
                    <p className="text-text-primary-dark me-8 mb-2"><strong>الابتكار والتطوير</strong> نهتم بالابتكار واستخدام أحدث التقنيات في مجال المقاولات وتسعى لتحسين عملياتنا وتطوير أساليب العمل لتلبية متطلبات السوق المتغيرة. وتشجع فريق العمل على التفكير الإبداعي وتقديم حلول جديدة وفعالة لحسين أداء المشاريع.</p>
                    <p className="text-text-primary-dark me-8 mb-2"><strong>الالتزام والمسؤولية</strong> نلتزم بتنفيذ المشاريع وفقا للمعايير القانونية والأخلاقية، ونحافظ على بيئة عمل آمنة وصحية لجميع العاملين معنا.</p>
                </div>
                <div className="2xl:w-1/2 mt-4 lg:mt-0 mb-8xl">
