...
const ExperienceSection = () => {
    ...
    return (
        <Container>
            <div className="py-10">
                <h2 className="text-large font-bold text-text-primary mb-4">
                    {t("experience.title")}
                </h2>
                <p className="text-text-grey text-medium mb-10">
                    {t("experience.description")}
                </p>

                <div
                    className={`flex flex-wrap items-end justify-center gap-6 ${
                        currentLang === "en" ? "flex-row-reverse" : ""
                    }`}
                    style={{ minHeight: "600px" }}
                >
                    {experiences.map((item, index) => (
                        <motion.div
                            key={index}
                            className={`relative ${
                                index === 0 ? "w-64 h-[596px]" : "w-52 h-[296px]"
                            } bg-text-dark text-white flex my-xl flex-col justify-end items-center`}
                            style={{
                                clipPath: (() => {
                                    if (item.text === "450+") {
                                        return currentLang === "en"
