...
const Navbar = () => {
    ...
    return (
        <nav className="bg-text-white shadow-md">
            <div className="max-w-7xl mx-auto px-l flex items-center justify-between h-24">
                ...
                <div className="hidden lg:flex space-x-8">
                    <a
                        href="/"
                        className={`${
                            isActive("/") ? "text-text-primary font-bold" : "text-text-grey font-medium"
                        } text-medium`}
                    >
                        Home
                    </a>
                    <a
                        href="/about"
                        className={`${
                            isActive("/about") ? "text-text-primary font-bold" : "text-text-grey font-medium"
                    ...
                    <a
                        href="/services"
                        className={`${
                            isActive("/services") ? "text-text-primary font-bold" : "text-text-grey font-medium"
                        } text-medium hover:text-text-primary`}
                    >
                        Our Services
                    </a>
                    <a
                        href="/projects"
                        className={`${
                            isActive("/projects") ? "text-text-primary font-bold" : "text-text-grey font-medium"
                        } text-medium hover:text-text-primary`}
                    >
                        Our Projects
                    </a>
                    <a
                        href="/contact"
                        className={`${
                            isActive("/contact") ? "text-text-primary font-bold" : "text-text-grey font-medium"
                        } text-medium hover:text-text-primary`}
                    >
                        Contact Us
                    </a>
